...
class CoinpaymentApi
{
    ...
    public function Setup($privateKey, $publicKey)
    {
    ...
    private function api_call($cmd, $req = array())
    {
        ...
        if ($this->ch === null) {
            ...
            curl_setopt($this->ch, CURLOPT_SSL_VERIFYPEER, config('coinpayment.ssl_verify_peer'));
            curl_setopt($this->ch, CURLOPT_SSL_VERIFYHOST, config('coinpayment.ssl_verify_host'));
        }
