                                                ...
                                                <div class="col-sm-8">
                                                    <div class="d-flex flex-wrap">
                                                        @foreach ($refund->filesUrlold() as $file)
                                                            <div class="me-2 user-img-con">
                                                                <a class="cursor_pointer" href='{{ $file }}'  data-lightbox="image-1"> <img class="profile-user-img img-responsive" width="80" height="80" src='{{ $file }}' alt="{{ __('Image') }}" class="img-thumbnail attachment-styles"></a>
                                                            </div>
                                                        @endforeach
                                                    </div>
                                                </div>
                                                    ...
                                                    <div>
                                                        <div class="d-flex mb-4">
                                                            @if (auth()->user()->id != $process->user->id)
                                                                ...
                                                                <div class="w-75 me-auto refund-chat">
                                                                    <div class="d-flex bio">
                                                                        <h5 class="user-name" class="m-0">{{ optional($process->user)->name }}</h5>
                                                                        <span class="m-0 title">{{ (auth()->user()->roles->first()->name == $process->user->roles()->first()->name) ? __('You') : $process->user->roles()->first()->name }}</span>
                                                                    </div>
                                                                    <div class="message">
