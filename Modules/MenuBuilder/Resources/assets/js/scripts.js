...
"use strict";
let depth = parseInt(menuId) == 4 ? 30 : 20; 
let maxDepth = parseInt(menuId) == 4 ? 11 : 1; 
! function(a) {
...
! function(a) {
    ...
    b = wpNavMenu = {
        ...
        jQueryExtensions: function() {
            a.fn.extend({
                ...
                shiftDepthClass: function(b) {
                    return this.each(function() {
                      //Query string present in the browser address bar is 'submitted=true&msg=success'
                      var list;
                        var c = a(this),
                            d = c.menuItemDepth();
                        ...
                        a(this).removeClass("menu-item-depth-" + d).addClass("menu-item-depth-" + (list))
        ...
        refreshAdvancedAccessibility: function() {
            a(".menu-item-settings .field-move a").css("display", "none"), a(".item-edit").each(function() {
                var b, c, d, e, f, g, h, i, j, k = a(this),
                    ...
                    o = (o.replace(/^\s+|\s+$/gm,''));
                0 !== p && (b = l.find(".menus-move-up"), b.prop("title", menus.moveUp).css("display", "none")), 0 !== p && n && (b = l.find(".menus-move-top"), b.prop("title", menus.moveToTop).css("display", "none")), p + 1 !== t && 0 !== p && (b = l.find(".menus-move-down"), b.prop("title", menus.moveDown).css("display", "none")), 0 === p && 0 !== u && (b = l.find(".menus-move-down"), b.prop("title", menus.moveDown).css("display", "none")), n || (b = l.find(".menus-move-left"), c = menus.outFrom.replace("%s", r), b.prop("title", menus.moveOutFrom.replace("%s", r)).html(c).css("display", "none")), 0 !== p && l.find(".menu-item-data-parent-id").val() !== l.prev().find(".menu-item-data-db-id").val() && (b = l.find(".menus-move-right"), c = menus.under.replace("%s", s), b.prop("title", menus.moveUnder.replace("%s", s)).html(c).css("display", "none")), n ? (d = a(".menu-item-depth-0"), e = d.index(l) + 1, t = d.length, f = menus.menuFocus.replace("%1$s", o).replace("%2$d", e).replace("%3$d", t)) : (g = l.prevAll(".menu-item-depth-" + parseInt(m - 1, 10)).first(), h = g.find(".menu-item-data-db-id").val(), i = g.find(".menu-item-title").text().replace(/^\s+|\s+$/gm,''), j = a('.menu-item .menu-item-data-parent-id[value="' + h + '"]'), e = a(j.parents(".menu-item").get().reverse()).index(l) + 1, f = menus.subMenuFocus.replace("%1$s", o).replace("%2$d", e).replace("%3$s", i)), k.prop("title", f).html(f)
            })
        },
        ...
        eventOnClickEditLink: function(b) {
            ...
            return e && e[1] && (c = a("#" + e[1]), d = c.parent(), 0 !== d.length) ? (d.hasClass("menu-item-edit-inactive") ? (c.data("menu-item-data") || c.data("menu-item-data", c.getItemData()), c.slideToggle(), d.removeClass("menu-item-edit-inactive").addClass("menu-item-edit-active")) : (c.slideToggle(), d.removeClass("menu-item-edit-active").addClass("menu-item-edit-inactive")), !1) : void 0
        },
