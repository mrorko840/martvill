                    ...
                    <div class="card card-info shadow-none" id="nav">
                        ...
                        <ul class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <li><a class="nav-link text-left tab-name" id="v-pills-restriction-tab" data-bs-toggle="pill"
                                    href="#v-pills-restriction" name="frfre" role="tab" aria-controls="v-pills-restriction"
                                    aria-selected="true"
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="d-flex date col-sm-6">
                                                        ...
                                                        <input class="form-control inputFieldDesign rounded-0 rounded-end" id="start_date"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="d-flex date col-sm-6">
                                                        ...
                                                        <input class="form-control rounded-0 rounded-end inputFieldDesign" id="end_date" type="text" name="end_date" required
                                                            oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                    ...
                                    <div class="tab-pane fade" id="v-pills-limit" role="tabpanel"
                                        ...
                                        <div class="modal-footer py-0">
                                            <div class="form-group row">
                                                ...
                                                <div class="m-auto">
                                                    <button type="submit"
                                                        class="btn form-submit custom-btn-submit float-right coupon-submit-button"
                                                        id="footer-btn">{{ __('Save') }}</button>
                                                    <a href="{{ route('coupon.index') }}"
                                                        class="py-2 me-2 form-submit custom-btn-cancel float-right coupon-submit-button all-cancel-btn">{{ __('Cancel') }}</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
