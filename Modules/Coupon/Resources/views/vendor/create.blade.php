                ...
                <div class="card card-info shadow-none" id="nav">
                    <div class="card-header pt-4 border-bottom text-nowrap">
                        ...
                        <ul class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <li><a class="nav-link text-left tab-name active" id="v-pills-general-tab" data-bs-toggle="pill" href="#v-pills-general" role="tab" aria-controls="v-pills-general" aria-selected="true" data-id="{{ __('General') }}">{{ __('General') }}</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" placeholder="{{ __('Name') }}" class="form-control inputFieldDesign" id="name" name="name" required maxlength="120" oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')" value="{{ old('name') }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-2 control-label require" for="code">{{ __('Code') }}</label>
                                                <div class="col-sm-6">
                                                    <input type="text" placeholder="{{ __('Code') }}" class="form-control inputFieldDesign" id="code" name="code" required maxlength="100" oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')" value="{{ old('code') }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row -mt-6">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="switch switch-bg d-inline m-r-10">
                                                        <input class="is_default" name="allow_free_shipping" type="checkbox" id="free_shipping">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="d-flex date col-sm-6">
                                                    ...
                                                    <input class="form-control inputFieldDesign rounded-0 rounded-end" id="start_date" type="text" name="start_date" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="d-flex date col-sm-6">
                                                    ...
                                                    <input class="form-control rounded-0 rounded-end inputFieldDesign" id="end_date" type="text" name="end_date" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 control-label text-left" for="minimum_spend">
                                            ...
                                            <div class="tooltips ms-2 cursor-pointer">
                                                ...
                                                <span class="tooltiptexts">{{ __('You must spend more than or equal this amount to get coupon discount.') }}</span>
                                            </div>
                                        </label>
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="{{ __('Minimum Spend') }}" class="form-control positive-float-number inputFieldDesign" id="minimum_spend" name="minimum_spend" value="{{ old('minimum_spend') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 control-label" for="usage_limit">
                                            ...
                                            <div class="tooltips ms-2 cursor-pointer">
                                                ...
                                                <span class="tooltiptexts">{{ __('How many times this coupon can be used.') }}</span>
                                            </div>
                                        </label>
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="{{ __('Usage Limit') }}" class="form-control positive-int-number inputFieldDesign" id="usage_limit" name="usage_limit" value="{{ old('usage_limit') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-footer py-0">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <a href="{{ route('vendor.coupons') }}" class="py-2 me-2 form-submit custom-btn-cancel float-right coupon-submit-button">{{ __('Cancel') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
