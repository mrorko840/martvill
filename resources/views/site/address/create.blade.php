            ...
            <div>
                <form action="{{ route('site.addressStore') }}" method="post" id="addressForm" onsubmit="return formValidation()">
                    ...
                    <div class="lg:mb-3 mb-3.5">
                        ...
                        <input class="border-gray-2 rounded-sm w-full mt-1.5 lg:mt-1p lg:h-46p h-10 roboto-medium pl-18p font-medium text-sm text-gray-10 form-control focus:border-gray-12"type="text" name="company_name" id="compnay_name" value="{{ old('company_name') }}">
                    </div>
                    <div class="grid lg:grid-cols-2 grid-cols-1 lg:gap-3">
                        ...
                        <div class="order-first lg:order-none lg:mb-3 mb-3.5">
                            ...
                            <input class="border-gray-2 mt-1.5 lg:mt-1p rounded-sm w-full lg:h-46p h-10 pl-18p roboto-medium font-medium text-sm text-gray-10 form-control focus:border-gray-12" type="email" name="email" id="email"
                    ...
                    <div class="grid grid-cols-2 lg:gap-3 gap-15p mb-3.5">
                        <div class="lg:mb-3 mb-3.5 validSelect">
                            ...
                            <select name="city" id="city" class="border-gray-2 rounded-sm w-full lg:h-46p mt-1.5 lg:mt-1p h-10 roboto-medium pl-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12 block required-field addressSelect" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')"><option value="">{{ __('Select City') }}</option>
                            </select>
                        </div>
                        <div class="lg:mb-3 mb-3.5">
                            ...
                            <input id="zip" name="zip" type="text" value="{{ old('zip') }}" class="border-gray-2 rounded-sm w-full h-46p mt-2 lg:mt-1p roboto-medium pl-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12">
                        </div>
                    </div>
                    ...
                    @if ($addresses->count() > 0)
                        <div class="form-check mt-0">
                            ...
                            <input name="is_default" value="1" class="h-4 w-4 border border-gray-2 rounded-sm bg-white text-gray-12 transition duration-200 lg:mt-1 mt-1.5 align-top mr-2 cursor-pointer" type="checkbox"
                                id="flexCheckDefault">
                    ...
                    <div class="flex lg:mt-5 mt-6">
                        ...
                        <button type="submit" id="btnSubmit" class="dm-sans lg:ml-3 ml-0 transition duration-200 items-center cursor-pointer py-3 px-6 font-medium text-sm whitespace-nowrap text-white bg-gray-12 save-add-func hover:bg-yellow-1 hover:text-gray-12 mb-7p rounded">{{ __('Save Address') }}</button>
                    </div>
                </form>
            </div>
        </div>
